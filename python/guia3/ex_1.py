...
""" Grafique la funcion amplitud A(w) del filtro truncado (puede utilizar la funcion implementada en el ejercicio 6 de la Guia 2) 
superpuesta a la amplitud deseada Ad(w) para comparar y observar el efecto producido en frecuencia debido al truncamiento en el tiempo. 
Utilice para la simulacion un vector de frecuencias w de por lo menos 2048 puntos. """
